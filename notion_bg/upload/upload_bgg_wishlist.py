...
def get_bgg_wishlist():
    bgg = BGGClient()
    games_batch = bgg.collection("nraw", wishlist=True, exclude_subtype="boardgameexpansion")
...
def get_notion_game_list():
    ...
    notion_game_list = [g['properties']['Name']['title'][0]['plain_text'] for g in results]
...
def create_bgg_game(game_id, game_data):
    ...
    json_data = {'parent': {'database_id': '14a0eda608be4da284229fe06491ecb7'},
 'properties': {
